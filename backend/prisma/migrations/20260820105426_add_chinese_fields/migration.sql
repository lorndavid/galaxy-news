-- AlterTable
ALTER TABLE "Article" ADD COLUMN "contentZh" TEXT;
ALTER TABLE "Article" ADD COLUMN "excerptZh" TEXT;
ALTER TABLE "Article" ADD COLUMN "titleZh" TEXT;

-- AlterTable
ALTER TABLE "Category" ADD COLUMN "descriptionZh" TEXT;
...
CREATE TABLE "new_SiteSettings" (
    ...
    "siteName" TEXT NOT NULL DEFAULT 'Galaxy TV V4K',
    "siteNameEn" TEXT,
    "logo" TEXT,
    "favicon" TEXT,
    "description" TEXT,
    ...
    "tickerLayout" TEXT NOT NULL DEFAULT 'fluid',
...
INSERT INTO "new_SiteSettings" ("accentColor", "address", "bodyBgColor", "borderColor", "contactEmail", "contactPhone", "defaultLanguage", "description", "descriptionEn", "facebook", "favicon", "fontArticle", "fontBody", "fontHeading", "fontSizeBody", "fontSizeCard", "fontSizeHero", "fontSizeSection", "footerBgColor", "footerTextColor", "headerBgColor", "headerTextColor", "id", "instagram", "layoutStyle", "logo", "mutedTextColor", "primaryColor", "radiusPreset", "secondaryColor", "shadowPreset", "shareFacebook", "shareTelegram", "shareTikTok", "shareWhatsapp", "siteName", "siteNameEn", "surfaceColor", "telegram", "telegramBotToken", "telegramButtonEn", "telegramButtonKh", "telegramChatId", "telegramDestinations", "telegramEnabled", "telegramLanguageMode", "telegramSiteUrl", "textColor", "tickerAccentColor", "tickerBgColor", "tickerCount", "tickerDirection", "tickerEnabled", "tickerLayout", "tickerRefresh", "tickerSpeed", "tickerTextColor", "tickerTitle", "tiktok", "twitter", "updatedAt", "youtube") SELECT "accentColor", "address", "bodyBgColor", "borderColor", "contactEmail", "contactPhone", "defaultLanguage", "description", "descriptionEn", "facebook", "favicon", "fontArticle", "fontBody", "fontHeading", "fontSizeBody", "fontSizeCard", "fontSizeHero", "fontSizeSection", "footerBgColor", "footerTextColor", "headerBgColor", "headerTextColor", "id", "instagram", "layoutStyle", "logo", "mutedTextColor", "primaryColor", "radiusPreset", "secondaryColor", "shadowPreset", "shareFacebook", "shareTelegram", "shareTikTok", "shareWhatsapp", "siteName", "siteNameEn", "surfaceColor", "telegram", "telegramBotToken", "telegramButtonEn", "telegramButtonKh", "telegramChatId", "telegramDestinations", "telegramEnabled", "telegramLanguageMode", "telegramSiteUrl", "textColor", "tickerAccentColor", "tickerBgColor", "tickerCount", "tickerDirection", "tickerEnabled", "tickerLayout", "tickerRefresh", "tickerSpeed", "tickerTextColor", "tickerTitle", "tiktok", "twitter", "updatedAt", "youtube" FROM "SiteSettings";
