...
export const adminService = {
  ...
  createNavItem(payload: { label: string; labelEn?: string | null; labelZh?: string | null; type: string; value?: string | null; isActive?: boolean; config?: NavigationItemConfig | null }) {
    return unwrap<NavigationItem>(api.post("/admin/navigation", payload));
  },
  updateNavItem(id: number, payload: { label?: string; labelEn?: string | null; labelZh?: string | null; type?: string; value?: string | null; isActive?: boolean; config?: NavigationItemConfig | null }) {
